 ...
 * Jedes der Elemente wird mit dem Element der zweiten Matrix addiert
 * @param, die beiden Matrissen, welche übergeben werden, müssen diesselbe Anzahl an Zeilen und Spalten haben
 * @return, die Summe der beiden Matrissen, als Matrix
 */
